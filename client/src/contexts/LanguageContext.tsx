...
const translations = {
  FR: {
    ...
    tp: {
      ...
      showcase: {
        title: 'Le produit,',
        titleItalic: 'dans votre poche.',
        desc: 'Réservez, suivez votre infirmière en temps réel, et accédez à vos rapports cliniques —',
        descBold: ' tout en quelques tapotements.',
        descTrail: ' Aucune carte requise pour explorer.',
        downloadDivider: "Téléchargez l'app",
        sectionLabel: 'Aperçu produit en direct',
      },
      services: {
        title: 'Six modalités.',
        subtitle: 'Une plateforme.',
        lede: 'Découvrez l\'éventail de nos prestations cliniques. Explorez le terminal pour les spécifications.',
      },
      features: {
        sectionLabel: 'Infrastructure en direct',
        title: "L'opération,",
        titleItalic: 'en marche.',
        subtitle: 'Couverture territoriale, communication directe et trajectoire de plateforme — sous une seule console.',
        coverageLabel: 'Réseau de couverture',
        coverageTitle: 'Carte opérationnelle — Québec en service, expansion confirmée.',
        channelLabel: 'Canal direct',
        channelTitle: 'Canal patient–infirmière. Chiffré, instantané, traçable.',
        regions: '14 régions · 1 en direct',
        encrypted: 'Chiffrement de bout en bout',
        matchingSub: 'Temps de réponse moyen.',
        satisfactionSub: 'Notation post-soin (5★ moyenne).',
        availabilitySub: 'Service continu, jour et nuit.',
        trajectoryLabel: 'Trajectoire de plateforme',
        trajectoryTitle: 'Projection de croissance.',
        trajectorySub: 'Adoption mensuelle, suivi post-lancement.',
      },
      chat: {
        patient: "Bonjour, j'ai besoin d'une infirmière pour un pansement ce soir.",
        match: 'Sarah B., infirmière OIIQ · à 8 min de chez vous.',
        nurse: 'En route — arrivée prévue à 18h30.',
        matchLabel: 'Correspondance trouvée',
        patientLabel: 'Patient',
        nurseLabel: 'Infirmière',
        timestamp: 'Échange · 2 min',
      },
      outcomes: {
        title: "Données réelles. Vérifiées par l'OIIQ et la communauté médicale du Québec.",
        meta: 'Mises à jour toutes les 24h depuis le tableau de bord opérationnel MobiSoins.',
        notePatients: 'Patients connectés depuis le lancement.',
        noteNurses: 'Infirmières actives en règle OIIQ.',
        noteSatisfaction: 'Patients ayant noté 5★ post-soin.',
        noteCities: 'Villes desservies — expansion 2025 en cours.',
      },
      testimonials: {
        tagline: 'Vérifiés. Signés. Datés.',
        verifiedPatient: 'Patient vérifié',
      },
      appDownload: {
        sectionLabel: 'Déploiement — application',
        subtitle: "Téléchargez l'app.",
        systemLabel: 'Deux plateformes — une expérience',
        title: 'Rejoignez MobiSoins sur votre téléphone.',
        desc: "Disponible gratuitement sur l'App Store et Google Play. Inscription en 60 secondes — aucune carte requise pour explorer.",
        tagline: "Réservez, suivez, payez — tout en quelques tapotements. Soins infirmiers OIIQ certifiés à portée de poche.",
        getStarted: 'Commencer avec MobiSoins',
        cost: 'Gratuit',
      },
      coverage: {
        live: 'En direct',
        expansion: 'Expansion 2025/26',
        soon: 'Bientôt',
        comingSoon: 'Bientôt',
        regionsLabel: 'Carte de couverture',
        regionsCount: '14 RÉGIONS / 1 EN DIRECT',
  ...
  EN: {
    ...
    tp: {
      ...
      showcase: {
        title: 'The product,',
        titleItalic: 'in your pocket.',
        desc: 'Book, track your nurse in real time, and access your clinical reports —',
        descBold: ' all in a few taps.',
        descTrail: ' No card required to explore.',
        downloadDivider: 'Download the app',
        sectionLabel: 'Live product preview',
      },
      services: {
        title: 'Six modalities.',
        subtitle: 'One platform.',
        lede: 'Explore our full range of clinical services. Open the terminal for specifications.',
      },
      features: {
        sectionLabel: 'Live infrastructure',
        title: 'Operations,',
        titleItalic: 'in motion.',
        subtitle: 'Coverage, direct communication, and platform trajectory — under one console.',
        coverageLabel: 'Coverage network',
        coverageTitle: 'Operational map — Quebec live, expansion confirmed.',
        channelLabel: 'Direct channel',
        channelTitle: 'Patient–nurse channel. Encrypted, instant, traceable.',
        regions: '14 regions · 1 live',
        encrypted: 'End-to-end encrypted',
        matchingSub: 'Average response time.',
        satisfactionSub: 'Post-care rating (5★ average).',
        availabilitySub: 'Continuous service, day and night.',
        trajectoryLabel: 'Platform trajectory',
        trajectoryTitle: 'Growth projection.',
        trajectorySub: 'Monthly adoption, post-launch tracking.',
      },
      chat: {
        patient: 'Hello, I need a nurse for a dressing change tonight.',
        match: 'Sarah B., OIIQ nurse · 8 min from you.',
        nurse: "On my way — arriving around 6:30 PM.",
        matchLabel: 'Match found',
        patientLabel: 'Patient',
        nurseLabel: 'Nurse',
        timestamp: 'Conversation · 2 min',
      },
      outcomes: {
        title: 'Real data. Verified by OIIQ and the Quebec medical community.',
        meta: 'Updated every 24h from the MobiSoins operational dashboard.',
        notePatients: 'Patients connected since launch.',
        noteNurses: 'Active OIIQ-licensed nurses.',
        noteSatisfaction: 'Patients who rated 5★ post-care.',
        noteCities: 'Cities served — 2025 expansion in progress.',
      },
      testimonials: {
        tagline: 'Verified. Signed. Dated.',
        verifiedPatient: 'Verified patient',
      },
      appDownload: {
        sectionLabel: 'Deploy — application',
        subtitle: 'Download the app.',
        systemLabel: 'Two platforms — one experience',
        title: 'Join MobiSoins on your phone.',
        desc: 'Available free on the App Store and Google Play. Sign up in 60 seconds — no card required to explore.',
        tagline: 'Book, track, pay — all in a few taps. OIIQ-certified nursing care at your fingertips.',
        getStarted: 'Get started with MobiSoins',
        cost: 'Free',
      },
      coverage: {
        ...
        regionsLabel: 'Coverage map',
        regionsCount: '14 REGIONS / 1 LIVE',
